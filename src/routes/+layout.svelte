...
<div data-theme="snappitheme" class="min-h-screen bg-primary/3">
  <div class="fixed top-0 left-0 right-0 z-50 flex justify-center w-full px-4 py-3">
	<nav class="navbar border-base-300 border-1 bg-base-100 backdrop-blur-lg shadow-lg w-full rounded-full px-6 max-w-5xl transition-all duration-200 hover:shadow-xl">
	  <div class="flex-1">
  ...
  <!-- Simplified Footer -->
   <footer class="bg-base-100 border-t border-accent w-full">
