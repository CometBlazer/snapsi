...
<div data-theme="light" class="min-h-screen bg-white">
  <div class="fixed top-0 left-0 right-0 z-50 flex justify-center w-full px-4 py-3">
	<nav class="navbar bg-white backdrop-blur-lg shadow-lg w-full rounded-full px-6 max-w-5xl transition-all duration-200 hover:shadow-xl">
	  <div class="flex-1">
	  ...
	  <div class="flex-none">
		...
		<div class="dropdown dropdown-end sm:hidden">
		  ...
		  <ul tabindex="0" class="menu menu-lg dropdown-content mt-3 z-[1] p-2 shadow-lg bg-white rounded-box w-52 font-bold">
			{#each navItems as item}
			  <li>
	...
	<footer class="px-6 py-8 md:py-12 max-w-6xl mx-auto">
	  <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12">
		...
		<div class="col-span-2 md:col-span-1 my-5 md:my-0">
		  <a href="/" class="flex flex-col space-y-4">
			...
			<p class="text-lg text-muted-foreground">Look Sharp. Stand Out.</p>
		  </a>
		</div>
	  ...
	  <div class="flex flex-col md:flex-row justify-between items-center mt-8 md:mt-12 pt-6 border-t">
		...
		<div class="flex items-center space-x-4">
		  <a href="https://instagram.com/unibooth_ai" target="_blank" class="p-2 rounded-full hover:bg-muted transition-colors duration-200" aria-label="Instagram">
			<!-- Instagram SVG -->
		  ...
		  <a href="https://linkedin.com/company/your-company" target="_blank" class="p-2 rounded-full hover:bg-muted transition-colors duration-200" aria-label="LinkedIn">
			<!-- LinkedIn SVG -->
			<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
		  ...
		  <a href="mailto:unibooth.business@gmail.com" target="_blank" class="p-2 rounded-full hover:bg-muted transition-colors duration-200" aria-label="Email">
